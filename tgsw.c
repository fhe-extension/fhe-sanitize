...
tlwe_sample blind_rotate(lwe_sample lwe, int n, uint64_t* testv, tgsw_sample *bsk)
{
  int max=_k*_N;
  int _2N=2*_N;
...
void bootstrap(lwe_sample ct, bsk bsk, ksk ksk, int M_out, int n)
{
  ...
  */
  ...
  tlwe_sample tmp_tlwe = blind_rotate(ct, n, test_vector, bsk);
